 ...
 */
public class AttributeListAdapter extends ArrayAdapter<Attribute> {

    private Context context;
    private int resource;
    private ArrayList<Attribute> Attributes;

    public AttributeListAdapter(Context context, int resource, ArrayList<Attribute> attributes) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        number_values.setText(context.getString(R.string.number_values) + " " + attr.getMAX());
