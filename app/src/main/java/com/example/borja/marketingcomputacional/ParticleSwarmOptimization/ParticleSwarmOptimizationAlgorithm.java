...
import com.example.borja.marketingcomputacional.area_input.fragments.InputCustomerProfiles;
...
public abstract class ParticleSwarmOptimizationAlgorithm {
    ...
    public ArrayList<Object> solvePSOAlgorithm() {
...
//                    product.getVelocity().put(TotalAttributes.get(p), vel);
    ...
    public abstract ArrayList<Object> createInitSwarm();
    ...
    protected abstract Integer getFitness(Object object);
}
