 ...
 */
public class MinimaxAlgorithmNEW extends Problem {

    private static MinimaxAlgorithmNEW MMAlgorithm = null;
    ...
    public static MinimaxAlgorithmNEW getInstance() {
        if (MMAlgorithm == null)
            MMAlgorithm = new MinimaxAlgorithmNEW();
